...
async function runMemoryBenchmark() {
  ...
  printMemoryStats(
    'Adaptive caching with low memory target',
    adaptiveCacheStats
  );
  ...
  printMemoryStats(
    'Adaptive caching with moderate memory target',
    adaptiveModerateCacheStats
  );
  ...
  console.log(
    `  - After first validation: ${firstRoundStats.heapUsedEnd.toFixed(2)} MB (+${firstRoundStats.delta.toFixed(2)} MB)`
  );
  ...
  console.log(
    `  - After second validation: ${secondRoundStats.heapUsedEnd.toFixed(2)} MB (+${secondRoundStats.delta.toFixed(2)} MB)`
  );
  ...
  console.log(
    `  - After 10 more validations: ${multipleRoundStats.heapUsedEnd.toFixed(2)} MB (+${multipleRoundStats.delta.toFixed(2)} MB)`
  );
